...
ALLOWED_HTML_TAGS = {
  ...
  'br':          {'parents': ['phrasing'], 'content': [], 'no-end-tag': True},
  ...
  'dd': {
    'parents': ['dl', 'div'], 'close-next': ['dd', 'dt'], 'content': ['flow']
  },
  ...
  'li': {
    'parents': ['ul', 'ol', 'menu'], 'close-next': ['li'], 'content': ['flow']
  },
  ...
  'references': {'parents': ['flow'],     'content': ['flow', 'phrasing']},
  'rp': {
    'parents':    ['ruby'],
    'close-next': ['rt', 'rtc', 'rp', 'rb'],
    'content':    ['text']},
  ...
  'templatestyles': {
    'parents': ['phrasing'], 'content': [], 'no-end-tag': True
  },
  'tfoot': {
    'parents':    ['table'],
    'close-next': ['thead', 'tbody', 'tfoot'],
  ...
  'wbr': {'parents': ['phrasing'], 'content': [], 'no-end-tag': True},
}
...
def nowiki_quote(text):
  ...
  def repl(m): return _nowiki_map[m.group(0)]
  return re.sub(_nowiki_re, repl, text)
